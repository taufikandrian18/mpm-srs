...
namespace MPMSRS.Migrations
{
    ...
    [Migration("20220616200517_insert-new-table-TB_PushNotifications")]
    partial class insertnewtableTB_PushNotifications
    {
            ...
            modelBuilder.Entity("MPMSRS.Models.Entities.PushNotifications", b =>
                {
                    b.HasOne("MPMSRS.Models.Entities.Users", "User")
                        ...
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_PushNotifications_Users")
                        .IsRequired();
