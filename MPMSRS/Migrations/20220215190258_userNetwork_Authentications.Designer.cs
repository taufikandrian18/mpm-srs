...
namespace MPMSRS.Migrations
{
    ...
    [Migration("20220215190258_userNetwork_Authentications")]
    partial class userNetwork_Authentications
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MPMSRS.Models.Entities.CorrectiveActions", b =>
                {
                    ...
                    b.Property<bool>("CorrectiveActionStatus")
                        .HasColumnType("bit");
                    ...
                    b.Property<Guid>("VisitingDetailId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MPMSRS.Models.Entities.VisitingDetails", b =>
                {
                    b.Property<Guid>("VisitingDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("VisitingDetailComment")
                        .IsRequired()
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");

                    b.Property<string>("VisitingDetailNotes")
                        .IsRequired()
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");

                    b.Property<bool>("VisitingDetailStatus")
                        .HasColumnType("bit");

                    b.Property<Guid>("VisitingId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("VisitingDetailId");

                    b.HasIndex("VisitingId");

                    b.ToTable("TB_Visiting_Details");
                });
            ...
            modelBuilder.Entity("MPMSRS.Models.Entities.CorrectiveActions", b =>
                {
                    b.HasOne("MPMSRS.Models.Entities.ProblemCategories", "ProblemCategory")
                        ...
                        .HasForeignKey("ProblemCategoryId")
                        .HasConstraintName("FK_CorrectiveActions_ProblemCategories")
                        .IsRequired();

                    b.HasOne("MPMSRS.Models.Entities.VisitingDetails", "VisitingDetail")
                        .WithMany("CorrectiveActions")
                        .HasForeignKey("VisitingDetailId")
                        .HasConstraintName("FK_CorrectiveActions_VisitingDetails")
                        .IsRequired();

                    b.Navigation("ProblemCategory");

                    b.Navigation("VisitingDetail");
                });
            ...
            modelBuilder.Entity("MPMSRS.Models.Entities.VisitingDetailReports", b =>
                {
                    b.HasOne("MPMSRS.Models.Entities.ProblemCategories", "ProblemCategory")
                        ...
                        .HasForeignKey("ProblemCategoryId")
                        .HasConstraintName("FK_VisitingDetailReports_ProblemCategories")
                        .IsRequired();

                    b.HasOne("MPMSRS.Models.Entities.VisitingDetails", "VisitingDetail")
                        .WithMany("VisitingDetailReports")
                        .HasForeignKey("VisitingDetailId")
                        .HasConstraintName("FK_VisitingDetailReports_VisitingDetails")
                        .IsRequired();
            ...
            modelBuilder.Entity("MPMSRS.Models.Entities.VisitingDetails", b =>
                {
                    b.HasOne("MPMSRS.Models.Entities.Visitings", "Visiting")
                        .WithMany("VisitingDetails")
                        .HasForeignKey("VisitingId")
                        .HasConstraintName("FK_VisitingDetails_Visitings")
                        .IsRequired();
